...
This project investigates how different optimization strategies, including mini-batching and momentum, affect the training and convergence of a neural network on a non-linear classification problem. I implemented stochastic gradient descent (SGD) with and without momentum and compared full-batch and mini-batch training.
...
The network was trained on a non-linear Annuli classification dataset with 300 samples and noise level of 1.0 (based on code not provided in this folder).
